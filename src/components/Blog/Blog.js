    ...
    <Row xs={1} md={2} className="g-4">
      <Col>
        <Card className="ms-3 mt-3 w-100 h-100">
          <Card.Body>
            <Card.Title style={{fontWeight:'bold'}}>Q:Difference between sql and nosql?</Card.Title>
            <Card.Text>
      ...
      <Col>
        <Card className="ms-3 w-100 h-100">
          <Card.Body>
            <Card.Title style={{fontWeight:'bold'}}>Q:What is difference between javascript and NodeJS?</Card.Title>
            <Card.Text>
      ...
      <Col>
        <Card className="me-3 w-100 h-100">
          <Card.Body>
            <Card.Title style={{fontWeight:'bold'}}>Q:How does NodeJS handle multiple request at same time?</Card.Title>
            <Card.Text>
